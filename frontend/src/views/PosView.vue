        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row g-3">
                    ...
                    >
                        <div
                            class="card shadow-sm h-100 border-0 bg-white"
            ...
            <div class="col-md-4">
                <div
                    class="card shadow border-primary sticky-top"
                    style="top: 20px"
                >
...
const processCheckout = async () => {
    try {
        // Format payload exactly how FastAPI wants it
